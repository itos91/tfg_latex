...
% P�gina que contiene el �ndice de contenidos del TFG
...
% P�gina que contiene el �ndice de listas de figuras
\cleardoublepage
\phantomsection
...
% P�gina que contiene el �ndice de listas de tablas
\cleardoublepage
\phantomsection
...
% P�gina que contiene el �ndice de listados de programaci�n
...
\hline
Comando & Descripci�n & Resposta & Configuraci�n & Par�metros \\
\hline
AT & Test de inicio & OK & - & - \\
\hline
AT+RST & Restea o m�dulo & Module info & - & -\\
\hline
AT+GMR & Devolve a versi�n \newline do m�dulo & Fw Version & - & - \\
\hline
...
\hline
AT+CWJAP & Con�ctase a AP & OK & AT+CWJAP=(ssid),(pwd) & ssid= Nombre red de AP, pwd= contrase�a de AP\\
\hline
AT+CWQAP & Finaliza a conexi�n con AP &  & AT+CWQAP & \\
\hline
AT+CWSAP & Configura os \newline parametros da AP & & AT+CWSAP=(ssid),(pwd), \newline (chl),(ecn) & ssid, contrase�a, \newline canal, encriptacion \\
\hline
AT+CWLIF & Comproba a \newline conexi�n IP do m�dulo &  & AT+CWLIF &  \\
\hline
AT+CIPSTATUS & Comproba a conexi�n & (id),(tipo),(direccion),(porto) & AT+CIPSTATUS & -   \\
\hline
\end{tabular}
}
\caption{Comandos b�sicos AT}
\label{comandosAT}
\end{table}
